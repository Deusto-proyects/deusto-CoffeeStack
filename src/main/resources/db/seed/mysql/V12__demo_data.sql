...
SELECT i.id, p.id, 'L-CAFE-001', 20.0, 17.0, DATE_ADD(CURRENT_DATE, INTERVAL 60 DAY), 18.50
FROM insumos i, proveedores p WHERE i.nombre = 'Café molido' AND p.nombre = 'Cafés del Mundo';

INSERT INTO lotes (insumo_id, proveedor_id, numero_lote, cantidad_inicial, cantidad_actual, fecha_vencimiento, precio_compra)
SELECT i.id, p.id, 'L-LECHE-001', 30.0, 22.0, DATE_ADD(CURRENT_DATE, INTERVAL 10 DAY), 1.20
...
SELECT id, 'L-AZUCAR-001', 10.0, 9.0, DATE_ADD(CURRENT_DATE, INTERVAL 365 DAY), 0.95
...
SELECT l.id, 'VENTA', 0.5, 'Venta de prueba (demo)', 'system', DATE_SUB(NOW(), INTERVAL 22 DAY)
FROM lotes l WHERE l.numero_lote = 'L-CAFE-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'VENTA', 0.7, 'Venta de prueba (demo)', 'system', DATE_SUB(NOW(), INTERVAL 18 DAY)
FROM lotes l WHERE l.numero_lote = 'L-CAFE-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'VENTA', 1.0, 'Venta de prueba (demo)', 'system', DATE_SUB(NOW(), INTERVAL 12 DAY)
FROM lotes l WHERE l.numero_lote = 'L-CAFE-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'MERMA', 0.8, 'Caducidad lote leche', 'system', DATE_SUB(NOW(), INTERVAL 15 DAY)
FROM lotes l WHERE l.numero_lote = 'L-LECHE-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'VENTA', 4.0, 'Venta de prueba (demo)', 'system', DATE_SUB(NOW(), INTERVAL 8 DAY)
FROM lotes l WHERE l.numero_lote = 'L-LECHE-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'VENTA', 3.2, 'Venta de prueba (demo)', 'system', DATE_SUB(NOW(), INTERVAL 4 DAY)
FROM lotes l WHERE l.numero_lote = 'L-LECHE-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'VENTA', 0.5, 'Venta de prueba (demo)', 'system', DATE_SUB(NOW(), INTERVAL 5 DAY)
FROM lotes l WHERE l.numero_lote = 'L-AZUCAR-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'VENTA', 120.0, 'Venta de prueba (demo)', 'system', DATE_SUB(NOW(), INTERVAL 6 DAY)
FROM lotes l WHERE l.numero_lote = 'L-VASOS-001';

INSERT INTO movimientos_inventario (lote_id, tipo_movimiento, cantidad, motivo, usuario, fecha_hora)
SELECT l.id, 'ROTURA', 5.0, 'Caja accidentada (demo)', 'system', DATE_SUB(NOW(), INTERVAL 10 DAY)
FROM lotes l WHERE l.numero_lote = 'L-VASOS-001';
